...
//#include "SingleCell/HumanVentricle_healthy_drug.cpp"
//#include "SingleCell/HumanVentricle_MI.cpp"
//#include "SingleCell/HumanVentricle_quinidine.cpp"
//#include "SingleCell/HumanVentricle_nifedipine.cpp"
//#include "SingleCell/HumanVentricle_verapamil.cpp"
//#include "SingleCell/HumanVentricle_bepridil.cpp"
//#include "SingleCell/HumanVentricle_vanoxerine.cpp"
//#include "SingleCell/HumanVentricle_amiodarone.cpp"
...
//	double ventCoeff = 0.1275; // 0.0106      0.154 for TP06
	...
	for(int i = 0; i < cellNum; i++)
	{
		...
		if(i == 59)
			coeff[i] = 0.2*ventCoeff;//HF Cx43*0.35
		else
			coeff[i] = ventCoeff;
		#endif
	}
	...
	#ifdef VENT
	FILE *datafile = fopen("Outputs/VentOneDResults_HF_CORM_HW50.dat","w+");
	#endif
	...
	for(time = 0.0, step = 0; time <= stopTime; time += dt, step++)
	{
		...
		//if( floor((time/BCL) >= numS1 - 8) && (time <= (numS1-8)*BCL+2000)) // output final cycle only
		//if( floor(time >= numS1*BCL-1948) && ((time/BCL) <= numS1)) // output final cycle only
