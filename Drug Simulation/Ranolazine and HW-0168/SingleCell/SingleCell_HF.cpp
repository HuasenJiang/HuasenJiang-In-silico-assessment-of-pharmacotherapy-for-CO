...
double Rnakr= 1/(1+pow(Ran/12.0,1.0));
double RnaNa= 1/(1+pow(Ran/53.6,2.4));
double RnaNaL= 1/(1+pow(Ran/6.23,1.0));
double RnaCaL= 1/(1+pow(Ran/296.0,1.0));
double RnaNaCa= 1/(1+pow(Ran/91.0,1.48));

double const HW =0.5;

double HWKr=1.8/(1.0+pow(0.41/HW,0.73))+1;
