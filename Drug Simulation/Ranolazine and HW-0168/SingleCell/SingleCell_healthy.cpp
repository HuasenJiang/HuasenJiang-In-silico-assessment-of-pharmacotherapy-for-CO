...
fclose(output);
output = fopen("output_baseline.txt","a");
#endif

#ifdef CON
output = fopen("CON.txt","w");
fclose(output);
output = fopen("CON.txt","a");
#endif

#ifdef CORM
output = fopen("CORM.txt","w");
fclose(output);
output = fopen("CORM.txt","a");
#endif

#ifdef CORM_Ran
output = fopen("CORM_Ran.txt","w");
fclose(output);
output = fopen("CORM_Ran.txt","a");

#ifdef CORM_HW
output = fopen("CORM_HW.txt","w");
fclose(output);
output = fopen("CORM_HW.txt","a");
#endif
...
//-------------------------------------------------------
		...
		#if defined (CON) || defined(Baseline) || defined(CORM) || defined(CORM_Ran) || defined(CORM_HW) 
...
#if defined (CON) || defined(Baseline) || defined(CORM) || defined(CORM_HW)
INaCa=INaCa_i+INaCa_ss;
#endif	

#ifdef CORM_Ran
INaCa=(INaCa_i+INaCa_ss)*RnaNaCa;
#endif
